...
class Rectangle:
    ...
    provides string and representation of the rectangle, detects instance deletion,
    and keeps track of the number of instances.
    The string representation of the rectangle can be customized with print_symbol.
    """
    ...
    def __str__(self):
        """
        Provides a string representation of the rectangle using the character in print_symbol.

        If width or height is 0, returns an empty string.

        Returns:
            str: A string representing the rectangle with the character(s) stored in print_symbol.
        """
        if self.__width == 0 or self.__height == 0:
            return ""
    ...
    def __repr__(self):
        """
        Provides a string representation of the rectangle that can be used with eval()
